...
let riderTableColumns = 
  [| 
    ...
    Utils.thcCreator(~header="Created", ~accessor="created_ts", ~width=100),
    Utils.thcCreator(~header="Updated", ~accessor="last_updated_ts", ~width=100),
    ...
    Utils.thcCreator(~header="Contact Method", ~accessor="RiderPreferredContact", ~width=100),
